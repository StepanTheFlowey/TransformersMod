...
public class ModelPurgesKatana extends ModelBase
{
    ...
    public ModelPurgesKatana()
    {
        ...
        this.base.addBox(-1.5F, 0F, -0.5F, 3, 1, 1, 0F);
        this.setRotateAngle(base, 0F, 1.5707963267948966F, 0F);
        this.blade18 = new ModelRenderer(this, 5, 23);
        this.blade18.setRotationPoint(0F, 4.5F, 0F);
        this.blade18.addBox(-1F, 0F, -1F, 2, 1, 2, 0F);
        this.blade20 = new ModelRenderer(this, 9, 19);
        this.blade20.setRotationPoint(-0.6F, 1F, 0F);
        this.blade20.addBox(-3F, 0F, -1F, 3, 1, 2, 0F);
        this.setRotateAngle(blade20, 0F, 0F, 0.890117918517108F);
        this.blade10 = new ModelRenderer(this, 11, 96);
        this.blade10.setRotationPoint(0.5F, -4.5F, 0F);
        this.blade10.addBox(-1F, -1F, -0.5F, 2, 2, 2, 0F);
        this.blade16 = new ModelRenderer(this, 6, 15);
        this.blade16.mirror = true;
        this.blade16.setRotationPoint(-1F, -3F, 0F);
        this.blade16.addBox(0F, -3F, 0F, 1, 3, 1, 0F);
        this.setRotateAngle(blade16, 0F, 0F, 0.22689280275926282F);
        this.blade9 = new ModelRenderer(this, 11, 96);
        this.blade9.setRotationPoint(0.5F, -2F, 0F);
        this.blade9.addBox(-1F, -1F, -0.5F, 2, 2, 2, 0F);
        this.blade8 = new ModelRenderer(this, 11, 96);
        this.blade8.setRotationPoint(0.5F, 0.5F, 0F);
        this.blade8.addBox(-1F, -1F, -0.5F, 2, 2, 2, 0F);
        this.blade14 = new ModelRenderer(this, 1, 10);
        this.blade14.mirror = true;
        this.blade14.setRotationPoint(-1.2F, -7F, 0F);
        this.blade14.addBox(0F, 0F, 0F, 1, 8, 1, 0F);
        this.blade5 = new ModelRenderer(this, 20, 96);
        this.blade5.setRotationPoint(0.5F, -1.9F, 0.5F);
        this.blade5.addBox(-0.5F, -2F, -0.5F, 1, 2, 1, 0F);
        this.setRotateAngle(blade5, 0F, -0.7853981633974483F, 0F);
        this.blade19 = new ModelRenderer(this, 9, 19);
        this.blade19.mirror = true;
        this.blade19.setRotationPoint(0.6F, 1F, 0F);
        this.blade19.addBox(0F, 0F, -1F, 3, 1, 2, 0F);
        this.setRotateAngle(blade19, 0F, 0F, -0.890117918517108F);
        this.blade7 = new ModelRenderer(this, 1, 20);
        this.blade7.setRotationPoint(-1.5F, -6.9F, 0.5F);
        this.blade7.addBox(0F, -0.5F, -0.5F, 2, 1, 1, 0F);
        this.setRotateAngle(blade7, 0.7853981633974483F, 0F, 0F);
        this.blade12 = new ModelRenderer(this, 6, 10);
        this.blade12.setRotationPoint(1F, 0F, 0F);
        this.blade12.addBox(-1F, -3F, 0F, 1, 3, 1, 0F);
        this.blade11 = new ModelRenderer(this, 1, 10);
        this.blade11.setRotationPoint(1.2F, -7F, 0F);
        this.blade11.addBox(0F, 0F, 0F, 1, 8, 1, 0F);
        this.blade3 = new ModelRenderer(this, 20, 96);
        this.blade3.setRotationPoint(-1F, -3F, 0F);
        this.blade3.addBox(0F, -2F, 0F, 1, 2, 1, 0F);
        this.blade1 = new ModelRenderer(this, 29, 90);
        this.blade1.setRotationPoint(-0.5F, -1F, -0.5F);
        this.blade1.addBox(0F, -6F, 0F, 1, 7, 1, 0F);
        this.blade13 = new ModelRenderer(this, 6, 15);
        this.blade13.setRotationPoint(0F, -3F, 0F);
        this.blade13.addBox(-1F, -3F, 0F, 1, 3, 1, 0F);
        this.setRotateAngle(blade13, 0F, 0F, -0.22689280275926282F);
        this.blade2 = new ModelRenderer(this, 24, 96);
        this.blade2.setRotationPoint(1F, -6F, 0F);
        this.blade2.addBox(-1F, -3F, 0F, 1, 3, 1, 0F);
        this.blade4 = new ModelRenderer(this, 11, 96);
        this.blade4.setRotationPoint(0.5F, -1.5F, 0F);
        this.blade4.addBox(-1F, -1F, -0.5F, 2, 2, 2, 0F);
        this.blade15 = new ModelRenderer(this, 6, 10);
        this.blade15.mirror = true;
        this.blade15.setRotationPoint(1F, 0F, 0F);
        this.blade15.addBox(-1F, -3F, 0F, 1, 3, 1, 0F);
        this.balde6 = new ModelRenderer(this, 11, 96);
        this.balde6.setRotationPoint(-0.5F, -1.5F, 0F);
        this.balde6.addBox(-1F, -1F, -0.5F, 2, 2, 2, 0F);
        this.blade17 = new ModelRenderer(this, 0, 23);
        this.blade17.setRotationPoint(0F, 0F, 0F);
        this.blade17.addBox(-0.5F, 1F, -0.5F, 1, 4, 1, 0F);
