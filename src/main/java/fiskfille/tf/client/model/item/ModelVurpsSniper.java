...
public class ModelVurpsSniper extends ModelBase {
	...
	public ModelVurpsSniper() {
		...
		bodypart2.setRotationPoint(0F, -0.6F, -4.8F);
		bodypart2.addBox(-1F, -1F, 0F, 2, 2, 4);
		setRotateAngle(bodypart2, 0F, 0F, 0.7853981633974483F);
		...
		setRotateAngle(monitorB, -0.08936085770210968F, 0F, 0F);
		...
		setRotateAngle(bottomPiece2, 0F, 0F, -1.0471975511965976F);
		handle = new ModelRenderer(this, 0, 0);
		handle.setRotationPoint(0F, -0.45F, 3F);
		handle.addBox(-0.5F, 0F, -1F, 1, 3, 2);
		setRotateAngle(handle, 0.4553564018453205F, 0F, 0F);
