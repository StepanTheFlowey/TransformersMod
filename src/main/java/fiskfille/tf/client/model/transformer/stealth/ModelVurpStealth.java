...
public class ModelVurpStealth extends ModelVurpVehicle {
	...
	public ModelVurpStealth() {
		...
		setRotateAngle(vehicleBase, 1.5707963267948966F, 0F, 0F);
		...
		setRotateAngle(vehicleWaistConnector1, 1.5707963267948966F, 0F, 0F);
		vehicleLowerLegR5 = new ModelRendererTF(this, 16, 75);
		vehicleLowerLegR5.setRotationPoint(-1.4F, 0F, 0F);
		...
		vehicleLowerLegL5.setRotationPoint(1.4F, 0F, 0F);
		...
		setRotateAngle(vehicleWindow2, -0.20943951023931953F, 0F, 0F);
		...
		vehicleHood3.setRotationPoint(0F, 0F, 0F);
