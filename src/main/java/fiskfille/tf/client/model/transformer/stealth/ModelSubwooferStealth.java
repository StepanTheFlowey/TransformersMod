...
public class ModelSubwooferStealth extends ModelSubwooferVehicle {
	...
	public ModelSubwooferStealth() {
		...
		vehicleCover6.addBox(-1F, 0F, 0F, 1, 4, 9, 0F);
		setRotateAngle(vehicleCover6, 0F, 0F, -0.017453292519943295F);
		...
		vehicleAntenna2.setRotationPoint(6F, 1.1F, 6F);
		vehicleAntenna2.addBox(-0.5F, -7F, -0.5F, 1, 7, 1, 0F);
		setRotateAngle(vehicleAntenna2, -0.7853981633974483F, 0F, 0F);
		...
		vehicleCover2.setRotationPoint(-4F, -4.5F, 3F);
		vehicleCover2.addBox(0F, 0F, 0F, 8, 1, 7, 0F);
		...
		vehicleCover1.setRotationPoint(-3F, -4.5F, 3F);
		vehicleCover1.addBox(0F, 0F, -5F, 6, 1, 6, 0F);
		setRotateAngle(vehicleCover1, -0.2844886680750757F, 0F, 0F);
		...
		vehicleAntenna1.setRotationPoint(0F, 1.1F, 6F);
		vehicleAntenna1.addBox(-0.5F, -6F, -0.5F, 1, 6, 1, 0F);
		setRotateAngle(vehicleAntenna1, -0.7853981633974483F, 0F, 0F);
		...
		vehicleDish2.addBox(-2F, -2F, -1F, 2, 2, 1, 0F);
