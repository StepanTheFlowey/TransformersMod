...
public class ModelSubwooferStealth extends ModelSubwooferVehicle {
	public final ModelRendererTF vehicleAntenna1;
	public final ModelRendererTF vehicleAntenna2;
	public final ModelRendererTF vehicleBase;
	public final ModelRendererTF vehicleBasePlate;
	public final ModelRendererTF vehicleBass2;
	public final ModelRendererTF vehicleBass3;
	public final ModelRendererTF vehicleCannonL1;
	public final ModelRendererTF vehicleCannonL2;
	public final ModelRendererTF vehicleCannonR1;
	public final ModelRendererTF vehicleCannonR2;
	public final ModelRendererTF vehicleChestMain1;
	public final ModelRendererTF vehicleChestMain2;
	public final ModelRendererTF vehicleChestMain3;
	public final ModelRendererTF vehicleChestMain5;
	public final ModelRendererTF vehicleChestMain6;
	public final ModelRendererTF vehicleCover1;
	public final ModelRendererTF vehicleCover2;
	public final ModelRendererTF vehicleCover3;
	public final ModelRendererTF vehicleCover4;
	public final ModelRendererTF vehicleCover5;
	public final ModelRendererTF vehicleCover6;
	public final ModelRendererTF vehicleCrotch1;
	public final ModelRendererTF vehicleDish1;
	public final ModelRendererTF vehicleDish2;
	public final ModelRendererTF vehicleFront1;
	public final ModelRendererTF vehicleFront2;
	public final ModelRendererTF vehicleFrontChestL;
	public final ModelRendererTF vehicleFrontChestR;
	public final ModelRendererTF vehicleFrontWheel1;
	public final ModelRendererTF vehicleFrontWheel2;
	public final ModelRendererTF vehicleHood;
	public final ModelRendererTF vehicleLowerArmL1;
	public final ModelRendererTF vehicleLowerArmRL1;
	public final ModelRendererTF vehicleLowerLegL1;
	public final ModelRendererTF vehicleLowerLegL3;
	public final ModelRendererTF vehicleLowerLegR1;
	public final ModelRendererTF vehicleLowerLegR3;
	public final ModelRendererTF vehicleRear1;
	public final ModelRendererTF vehicleRear2;
	public final ModelRendererTF vehicleRearWheel1;
	public final ModelRendererTF vehicleRearWheel2;
	public final ModelRendererTF vehicleRpg1;
	public final ModelRendererTF vehicleRpg2;
	public final ModelRendererTF vehicleShoulderBaseL;
	public final ModelRendererTF vehicleShoulderBaseR;
	public final ModelRendererTF vehicleStomach;
	public final ModelRendererTF vehicleUpperArmL;
	public final ModelRendererTF vehicleUpperArmR;
	public final ModelRendererTF vehicleUpperLegL;
	public final ModelRendererTF vehicleUpperLegR;
	...
	public ModelSubwooferStealth() {
		...
		vehicleLowerArmL1.addBox(-1.3F, -0.6F, -1.5F, 3, 5, 3, 0F);

		vehicleChestMain6 = new ModelRendererTF(this, 0, 89);
		vehicleChestMain6.mirror = true;
		vehicleChestMain6.setRotationPoint(-2.9F, 0.5F, 3F);
		vehicleChestMain6.addBox(-1F, -2F, 0F, 2, 3, 4, 0F);
		setRotateAngle(vehicleChestMain6, 3.141592653589793F, 0F, 0F);

		vehicleChestMain1 = new ModelRendererTF(this, 0, 67);
		vehicleChestMain1.setRotationPoint(0F, -2F, 0F);
		vehicleChestMain1.addBox(-4F, -4F, -3F, 8, 4, 6, 0F);
		setRotateAngle(vehicleChestMain1, -1.5707963267948966F, 0F, 0F);

		vehicleLowerLegR1 = new ModelRendererTF(this, 76, 66);
		vehicleLowerLegR1.mirror = true;
		vehicleLowerLegR1.setRotationPoint(-1.3F, 2.5F, -1F);
		vehicleLowerLegR1.addBox(-1.7F, -1.5F, -1.5F, 3, 6, 4, 0F);

		vehicleCover3 = new ModelRendererTF(this, 0, 0);
		vehicleCover3.mirror = true;
		vehicleCover3.setRotationPoint(-4.1F, -3.9F, -3.4F);
		vehicleCover3.addBox(0F, 0F, 0F, 1, 3, 14, 0F);

		vehicleChestMain2 = new ModelRendererTF(this, 18, 62);
		vehicleChestMain2.setRotationPoint(-3F, -0.6F, -6.1F);
		vehicleChestMain2.addBox(0F, 0F, 0.3F, 6, 3, 2, 0F);
		setRotateAngle(vehicleChestMain2, 0.03490658503988659F, 0F, 0F);

		vehicleUpperLegR = new ModelRendererTF(this, 76, 58);
		vehicleUpperLegR.mirror = true;
		vehicleUpperLegR.setRotationPoint(-4F, 1F, 0F);
		vehicleUpperLegR.addBox(-2F, -1F, -2F, 2, 5, 3, 0F);
		setRotateAngle(vehicleUpperLegR, 1.5707963267948966F, 0F, 0F);

		vehicleBase = new ModelRendererTF(this, 0, 98);
		vehicleBase.setRotationPoint(0F, 20F, -0.5F);
		vehicleBase.addBox(-3.5F, 0F, -2.5F, 7, 2, 5, 0F);
		...
		vehicleChestMain3.setRotationPoint(-3F, -4F, 3F);
		...
		vehicleRear1.setRotationPoint(-4F, -0.5F, 7F);
		vehicleRear1.addBox(0F, 0F, 0F, 8, 4, 2, 0F);
		...
		vehicleCover6.rotateAngleZ = -0.017453292519943295F;
		...
		vehicleFrontWheel2.addBox(0F, -1.5F, -1.5F, 2, 3, 3, 0F);

		vehicleFrontChestR = new ModelRendererTF(this, 10, 77);
		vehicleFrontChestR.setRotationPoint(-4F, -4F, -3F);
		vehicleFrontChestR.addBox(0F, 0F, -0.6F, 4, 4, 1, 0F);
		setRotateAngle(vehicleFrontChestR, -0.07330382858376185F, 0F, -0.005235987755982988F);

		vehicleRearWheel2 = new ModelRendererTF(this, 0, 77);
		vehicleRearWheel2.setRotationPoint(0.2F, 4.4F, -0.5F);
		vehicleRearWheel2.addBox(0F, -1.5F, -1.5F, 2, 3, 3, 0F);

		vehicleLowerLegL3 = new ModelRendererTF(this, 79, 82);
		vehicleLowerLegL3.setRotationPoint(0.9F, -1.6F, 1.9F);
		vehicleLowerLegL3.addBox(0F, 0F, 0F, 1, 7, 2, 0F);
		setRotateAngle(vehicleLowerLegL3, 0F, -0.6108652381980153F, 0F);

		vehicleFrontWheel1 = new ModelRendererTF(this, 0, 77);
		vehicleFrontWheel1.setRotationPoint(-2.5F, 1.5F, -3.7F);
		vehicleFrontWheel1.addBox(-2F, -1.5F, -1.5F, 2, 3, 3, 0F);
		...
		vehicleCover5.addBox(0F, 0F, 0F, 1, 4, 9, 0F);
		setRotateAngle(vehicleCover5, 0F, 0F, 0.017453292519943295F);

		vehicleCannonL1 = new ModelRendererTF(this, 39, 14);
		vehicleCannonL1.setRotationPoint(0.9F, -0.5F, -0.1F);
		vehicleCannonL1.addBox(0F, -3F, 0F, 1, 3, 1, 0F);

		vehicleFrontChestL = new ModelRendererTF(this, 10, 77);
		vehicleFrontChestL.mirror = true;
		vehicleFrontChestL.setRotationPoint(4F, -4F, -3F);
		vehicleFrontChestL.addBox(-4F, 0F, -0.6F, 4, 4, 1, 0F);
		setRotateAngle(vehicleFrontChestL, -0.07330382858376185F, 0F, 0.005235987755982988F);

		vehicleShoulderBaseL = new ModelRendererTF(this, 48, 78);
		vehicleShoulderBaseL.setRotationPoint(1F, -1.9F, 0F);
		vehicleShoulderBaseL.addBox(-0.1F, -1F, -1.4F, 3, 2, 3, 0F);
		setRotateAngle(vehicleShoulderBaseL, 1.5707963267948966F, 0F, 0F);

		vehicleDish1 = new ModelRendererTF(this, 0, 67);
		vehicleDish1.setRotationPoint(-4F, -4.6F, 6.2F);
		vehicleDish1.addBox(-2F, -3F, 0F, 2, 3, 1, 0F);
		...
		vehicleLowerLegR3.addBox(-1F, 0F, 0F, 1, 7, 2, 0F);
		setRotateAngle(vehicleLowerLegR3, 0F, 0.5235987755982988F, 0F);

		vehicleCover4 = new ModelRendererTF(this, 0, 0);
		vehicleCover4.setRotationPoint(4.1F, -3.9F, -3.4F);
		vehicleCover4.addBox(-1F, 0F, 0F, 1, 3, 14, 0F);
		setRotateAngle(vehicleCover4, 0.006283185307179587F, 0F, 0F);

		vehicleLowerLegL1 = new ModelRendererTF(this, 76, 66);
		vehicleLowerLegL1.setRotationPoint(1.3F, 2.5F, -1F);
		vehicleLowerLegL1.addBox(-1.3F, -1.5F, -1.5F, 3, 6, 4, 0F);

		vehicleBass2 = new ModelRendererTF(this, 0, 112);
		vehicleBass2.setRotationPoint(1.7F, -2.5F, 2.1F);
		vehicleBass2.addBox(0F, 0F, 0F, 1, 4, 3, 0F);
		setRotateAngle(vehicleBass2, 0F, 1.5707963267948966F, 0F);
		...
		vehicleCover1.addBox(0, 0, -5, 6, 1, 6, 0);
		vehicleCover1.rotateAngleX = -0.2844886680750757F;

		vehicleStomach = new ModelRendererTF(this, 0, 58);
		vehicleStomach.setRotationPoint(0F, 1F, 0F);
		vehicleStomach.addBox(-2.5F, -5.5F, -2F, 5, 5, 4, 0F);
		setRotateAngle(vehicleStomach, 1.5707963267948966F, 0F, 0F);
		...
		vehicleLowerArmRL1.addBox(-1.7F, -0.6F, -1.5F, 3, 5, 3, 0F);
		...
		vehicleAntenna1.rotateAngleX = -0.7853981633974483F;

		vehicleRear2 = new ModelRendererTF(this, 0, 29);
		vehicleRear2.setRotationPoint(-4F, -2.5F, 8F);
		vehicleRear2.addBox(0F, -1F, 0F, 8, 3, 1, 0F);
		...
		vehicleRearWheel1.addBox(-2F, -1.5F, -1.5F, 2, 3, 3, 0F);

		vehicleUpperLegL = new ModelRendererTF(this, 76, 58);
		vehicleUpperLegL.setRotationPoint(4F, 1F, 0F);
		vehicleUpperLegL.addBox(0F, -1F, -2F, 2, 5, 3, 0F);
		setRotateAngle(vehicleUpperLegL, 1.5707963267948966F, 0F, 0F);

		vehicleChestMain5 = new ModelRendererTF(this, 0, 89);
		vehicleChestMain5.setRotationPoint(2.9F, 0.5F, 3F);
		vehicleChestMain5.addBox(-1F, -2F, 0F, 2, 3, 4, 0F);
		setRotateAngle(vehicleChestMain5, 3.141592653589793F, 0F, 0F);

		vehicleUpperArmR = new ModelRendererTF(this, 61, 79);
		vehicleUpperArmR.setRotationPoint(-1.7F, 1F, 0F);
		vehicleUpperArmR.addBox(-1F, -0.2F, -1F, 2, 4, 2, 0F);

		vehicleCannonR1 = new ModelRendererTF(this, 39, 14);
		vehicleCannonR1.setRotationPoint(-0.9F, -0.5F, -0.1F);
		vehicleCannonR1.addBox(-1F, -3F, 0F, 1, 3, 1, 0F);

		vehicleHood = new ModelRendererTF(this, 0, 18);
		vehicleHood.setRotationPoint(-4F, -1F, -3F);
		vehicleHood.addBox(0F, 0F, -2.8F, 8, 1, 3, 0F);
		setRotateAngle(vehicleHood, 0.13962634015954636F, 0F, 0F);

		vehicleBasePlate = new ModelRendererTF(this, 20, 2);
		vehicleBasePlate.setRotationPoint(-3F, 1.6F, -5.4F);
		vehicleBasePlate.addBox(0F, 0F, 0F, 6, 1, 16, 0F);

		vehicleBass3 = new ModelRendererTF(this, 0, 112);
		vehicleBass3.mirror = true;
		vehicleBass3.setRotationPoint(-2.3F, -2.5F, 2.1F);
		vehicleBass3.addBox(0F, 0F, 0F, 1, 4, 3, 0F);
		setRotateAngle(vehicleBass3, 0F, 1.5707963267948966F, 0F);

		vehicleShoulderBaseR = new ModelRendererTF(this, 48, 78);
		vehicleShoulderBaseR.setRotationPoint(-1F, -1.9F, 0F);
		vehicleShoulderBaseR.addBox(-2.9F, -1F, -1.4F, 3, 2, 3, 0F);
		setRotateAngle(vehicleShoulderBaseR, 1.5707963267948966F, 0F, 0F);

		vehicleDish2 = new ModelRendererTF(this, 22, 67);
		vehicleDish2.setRotationPoint(0F, -3F, 1F);
		vehicleDish2.addBox(-2, -2, -1, 2, 2, 1, 0);
		setRotateAngle(vehicleDish2, 0.2792526803190927F, 0F, 0F);
