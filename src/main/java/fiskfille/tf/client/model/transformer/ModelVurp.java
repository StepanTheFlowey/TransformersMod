...
public class ModelVurp extends ModelTransformerBase {
	...
	public final ModelRendererTF kneeR1;
	public final ModelRendererTF lowerLegR;
	...
	public final ModelRendererTF kneeL1;
	public final ModelRendererTF lowerLegL;
	...
	public void doTransformationAnimations(EntityPlayer player, float progress, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, boolean wearingHead, boolean wearingChest, boolean wearingLegs, boolean wearingFeet) {
		...
		if(TFHelper.getTransformationTimer(player) != 0) {
			...
			lowerLegR.rotateAngleX = 0.24434609527920614F + (PI - 0.24434609527920614F) * progress;
			lowerLegL.rotateAngleX = 0.24434609527920614F + (PI - 0.24434609527920614F) * progress;
			lowerLegR.setRotationPoint(-1 + progress / 2.1F, 0.4F + 2.5F * progress, -1 + 2.5F * progress);
			lowerLegL.setRotationPoint(1 - progress / 2.1F, 0.4F + 2.5F * progress, -1 + 2.5F * progress);
			...
			setRotateAngle(lowerArmL, -0.5235987755982988F * f, 0.06981317007977318F * f, 0.12217304763960307F * f);
			...
			lowerArmL.setRotationPoint(1 + progress / 5, 3.3F - 1.75F * progress, -0.6F);
			fistR.rotateAngleZ = progress * -PI / 2;
			setRotateAngle(lowerArmR, -0.5235987755982988F * f, -0.06981317007977318F * f, -0.12217304763960307F * f);
			...
			lowerArmR.setRotationPoint(-progress / 5, 3.3F - 1.75F * progress, -0.6F);
