...
public class ModelVurp extends ModelTransformerBase {
	public final ModelRendererTF armbaseL1;
	public final ModelRendererTF armbaseR1;
	public final ModelRendererTF backplate1;
	public final ModelRendererTF backplate2;
	public final ModelRendererTF connector1;
	public final ModelRendererTF connector2;
	public final ModelRendererTF fistL;
	public final ModelRendererTF fistR;
	public final ModelRendererTF footbaseL;
	public final ModelRendererTF footbaseR;
	public final ModelRendererTF footL1;
	public final ModelRendererTF footL2;
	public final ModelRendererTF footL3;
	public final ModelRendererTF footR1;
	public final ModelRendererTF footR2;
	public final ModelRendererTF footR3;
	public final ModelRendererTF frontL1;
	public final ModelRendererTF frontL2;
	public final ModelRendererTF frontR1;
	public final ModelRendererTF frontR2;
	public final ModelRendererTF fronttorso1;
	public final ModelRendererTF head;
	public final ModelRendererTF headback1;
	public final ModelRendererTF headback2;
	public final ModelRendererTF headback3;
	public final ModelRendererTF hood1;
	public final ModelRendererTF hood2;
	public final ModelRendererTF hood3;
	public final ModelRendererTF hood4;
	public final ModelRendererTF kneeL;
	public final ModelRendererTF kneeR;
	...
	public final ModelRendererTF ribs1;
	public final ModelRendererTF ribs2;
	public final ModelRendererTF shoulderL1;
	public final ModelRendererTF shoulderpadL;
	public final ModelRendererTF shoulderpadR;
	public final ModelRendererTF shoulderR1;
	public final ModelRendererTF torsobase;
	public final ModelRendererTF torsoconnector1;
	public final ModelRendererTF torsodetail1;
	public final ModelRendererTF torsodetail2;
	public final ModelRendererTF torsodetail3;
	public final ModelRendererTF torsodetail4;
	...
	public final ModelRendererTF visor1;
	public final ModelRendererTF visor2;
	public final ModelRendererTF visor3;
	public final ModelRendererTF visor4;
	public final ModelRendererTF waist;
	public final ModelRendererTF waist1;
	public final ModelRendererTF waist2;
	public final ModelRendererTF waist3;
	public final ModelRendererTF waistconnector1;
	...
	public ModelVurp() {
		...
		kneeR = new ModelRendererTF(this, 10, 71);
		kneeR.setRotationPoint(0, 2.7F, 0);
		kneeR.addBox(-2, 0, -1, 2, 2, 2);
		setRotateAngle(kneeR, 0.148352986419518F, 0.017453292519943295F, -0.12217304763960307F);
		...
		lowerLegL1 = new ModelRendererTF(this, 0, 77);
		lowerLegL1.mirror = true;
		lowerLegL1.setRotationPoint(1, 0.4F, -1);
		lowerLegL1.addBox(-1.5F, 0, 0, 3, 6, 2);
		setRotateAngle(lowerLegL1, 0.24434609527920614F, 0, 0);
		...
		lowerArmR1 = new ModelRendererTF(this, 64, 65);
		lowerArmR1.mirror = true;
		lowerArmR1.setRotationPoint(0, 3.3F, -0.6F);
		lowerArmR1.addBox(-0.9F, -0.2F, -1.6F, 2, 4, 3);
		setRotateAngle(lowerArmR1, -0.5235987755982988F, -0.06981317007977318F, -0.12217304763960307F);
		...
		kneeL = new ModelRendererTF(this, 10, 71);
		kneeL.setRotationPoint(0, 2.7F, 0);
		kneeL.addBox(0, 0, -1, 2, 2, 2);
		setRotateAngle(kneeL, 0.148352986419518F, -0.017453292519943295F, 0.12217304763960307F);
		...
		lowerArmL1 = new ModelRendererTF(this, 64, 65);
		lowerArmL1.setRotationPoint(1, 3.3F, -0.6F);
		lowerArmL1.addBox(-1.1F, -0.2F, -1.6F, 2, 4, 3);
		setRotateAngle(lowerArmL1, -0.5235987755982988F, 0.06981317007977318F, 0.12217304763960307F);
		...
		lowerLegR1 = new ModelRendererTF(this, 0, 77);
		lowerLegR1.setRotationPoint(-1, 0.4F, -1);
		lowerLegR1.addBox(-1.5F, 0, 0, 3, 6, 2);
		setRotateAngle(lowerLegR1, 0.24434609527920614F, 0, 0);

		footbaseR.addChild(footR3);
		torsobase.addChild(connector1);
		torsobase.addChild(torsodetail3);
		lowerLegL1.addChild(footbaseL);
		torsobase.addChild(torsodetail4);
		kneeR.addChild(lowerLegR1);
		waist.addChild(waist1);
		lowerArmL1.addChild(fistL);
		...
		lowerLegR1.addChild(lowerlegR6);
		kneeL.addChild(lowerLegL1);
		lowerLegR1.addChild(lowerlegR5);
		lowerLegR2.addChild(lowerlegR3);
		upperArmR.addChild(lowerArmR1);
		waist.addChild(waist3);
		lowerArmR1.addChild(fistR);
		...
		lowerLegL1.addChild(lowerlegL6);
		...
		upperLegL.addChild(kneeL);
		headback1.addChild(visor3);
		kneeL.addChild(lowerlegL7);
		kneeR.addChild(lowerlegR7);
	...
	public void doWalkingAnimations(EntityPlayer player, float progress, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, boolean wearingHead, boolean wearingChest, boolean wearingLegs, boolean wearingFeet) {
		...
		if(player.isSneaking()) {
			...
			lowerLegR1.rotateAngleX += 1F;
			lowerLegL1.rotateAngleX += 1F;
			lowerLegR1.rotationPointY += 2F;
			lowerLegL1.rotationPointY += 2F;
	...
	public void doTransformationAnimations(EntityPlayer player, float progress, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, boolean wearingHead, boolean wearingChest, boolean wearingLegs, boolean wearingFeet) {
		...
		if(TFHelper.getTransformationTimer(player) != 0) {
			...
			setRotateAngle(kneeR, 0, 0, 0);
			setRotateAngle(kneeL, 0, 0, 0);
			setRotateAngle(lowerLegR1, 0, 0, 0);
			setRotateAngle(lowerLegL1, 0, 0, 0);
			setRotateAngle(upperLegR, 0, 0, 0);
			setRotateAngle(upperLegL, 0, 0, 0);
			lowerLegR1.rotateAngleX = 0.24434609527920614F + ((float) Math.PI - 0.24434609527920614F) * progress;
			lowerLegL1.rotateAngleX = 0.24434609527920614F + ((float) Math.PI - 0.24434609527920614F) * progress;
			lowerLegR1.setRotationPoint(-1 + progress / 2.1F, 0.4F + 2.5F * progress, -1 + 2.5F * progress);
			lowerLegL1.setRotationPoint(1 - progress / 2.1F, 0.4F + 2.5F * progress, -1 + 2.5F * progress);
			footbaseR.rotateAngleX = -0.24434609527920614F + progress * 1.7F;
			footbaseR.rotationPointZ = 0.7F - 2.5F * progress;
			footbaseL.rotateAngleX = -0.24434609527920614F + progress * 1.7F;
			footbaseL.rotationPointZ = 0.7F - 2.5F * progress;
			head.rotateAngleX = (float) Math.PI * progress;
			footbaseR.rotationPointX = progress;
			footbaseL.rotationPointX = -progress;
			lowerlegR7.setRotationPoint(0.5F, -0.2F + progress * 1.25F, -1 + 3 * progress);
			lowerlegL7.setRotationPoint(-0.5F, -0.2F + progress * 1.25F, -1 + 3 * progress);
			lowerlegR6.setRotationPoint(1 - 2 * progress, 2 * progress, 2 + progress / 2);
			lowerlegR6.rotateAngleY = -(float) Math.PI / 2 * progress;
			lowerlegR6.rotateAngleX = 0.45378560551852565F * f;
			lowerlegL6.setRotationPoint(-1 + 2 * progress, 2 * progress, 2 + progress / 2);
			lowerlegL6.rotateAngleY = (float) Math.PI / 2 * progress;
			lowerlegL6.rotateAngleX = -0.45378560551852565F * f;
			backplate2.setRotationPoint(progress * -2.01F, -3 + 4.5F * progress, 3);
			setRotateAngle(backplate2, 0.017453292519943295F * f, 0.12217304763960307F * f - progress * (float) Math.PI / 2, -0.10471975511965977F * f);
			backplate1.setRotationPoint(progress * 2.01F, -3 + 4.5F * progress, 3);
			setRotateAngle(backplate1, 0.017453292519943295F * f, 0.12217304763960307F * f + progress * (float) Math.PI / 2, -0.10471975511965977F * f);
			fistL.rotateAngleZ = progress * (float) Math.PI / 2;
			setRotateAngle(lowerArmL1, -0.5235987755982988F * f, 0.06981317007977318F * f, 0.12217304763960307F * f);
			setRotateAngle(upperArmL, 0.22689280275926282F * f, 0, 0);
			setRotateAngle(armbaseL1, 0, -0.10471975511965977F * f - 1.3F * progress, -0.17453292519943295F * f);
			armbaseL1.setRotationPoint(3 - progress * 1.8F, -2 + progress * 2.5F, 1);
			lowerArmL1.setRotationPoint(1 + progress / 5, 3.3F - 1.75F * progress, -0.6F);
			fistR.rotateAngleZ = progress * -(float) Math.PI / 2;
			setRotateAngle(lowerArmR1, -0.5235987755982988F * f, -0.06981317007977318F * f, -0.12217304763960307F * f);
			setRotateAngle(upperArmR, 0.22689280275926282F * f, 0, 0);
			setRotateAngle(armbaseR1, 0, 0.10471975511965977F * f + 1.3F * progress, 0.17453292519943295F * f);
			armbaseR1.setRotationPoint(-3 + progress * 2F, -2 + progress * 2.5F, 1);
			lowerArmR1.setRotationPoint(-progress / 5, 3.3F - 1.75F * progress, -0.6F);
			waist1.rotationPointZ += progress;
			waist2.rotationPointZ += progress;
			rotateTo(frontR1, vehicle.vehiclefrontR1, progress);
			rotateTo(frontL1, vehicle.vehiclefrontL1, progress);
			rotateTo(hood1, vehicle.vehiclehood1, progress);
			frontR1.rotateAngleX -= (float) Math.PI / 2;
			frontL1.rotateAngleX -= (float) Math.PI / 2;
			hood1.rotateAngleX -= (float) Math.PI / 2;
			frontR1.rotationPointZ += 1.75F * progress;
			frontL1.rotationPointZ += 1.75F * progress;
			hood1.setRotationPoint(0, -0.5F - 2.2F * progress, -1.8F + 3.2F * progress);
			shoulderpadR.setRotationPoint(-2 - progress * 1.5F, -3 + progress * 2, 1 - progress * 0.7F);
			shoulderpadL.setRotationPoint(2 + progress * 1.5F, -3 + progress * 2, 1 - progress * 0.7F);
			setRotateAngle(shoulderpadR, 0.20943951023931953F * f, 0, 1.064650843716541F * f);
			setRotateAngle(shoulderpadL, -0.20943951023931953F * f, 0, 1.064650843716541F * f);
		}

		final ItemStack heldItemStack = player.getHeldItem();
		if(heldItemStack != null && heldItemStack.getItem() instanceof ItemVurpsSniper) {
			upperArmR.rotateAngleX = -0.3F;
			lowerArmR1.rotateAngleX = -1;
			lowerArmR1.rotateAngleY = -0.5F;
			lowerArmR1.rotateAngleZ = -0.3F;
			upperArmL.rotateAngleX = -0.8F;
			upperArmL.rotateAngleZ = 0.3F;
			lowerArmL1.rotateAngleX = -0.3F;
			lowerArmL1.rotateAngleY = 0.7F;
			lowerArmL1.rotateAngleZ = 0.7F;
		}
	}
