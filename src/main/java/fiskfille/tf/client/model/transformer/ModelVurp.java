...
public class ModelVurp extends ModelTransformerBase {
	...
	public void doTransformationAnimations(EntityPlayer player, float progress, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, boolean wearingHead, boolean wearingChest, boolean wearingLegs, boolean wearingFeet) {
		...
		if(TFHelper.getTransformationTimer(player) != 0) {
			...
			lowerLegR1.rotateAngleX = 0.24434609527920614F + (PI - 0.24434609527920614F) * progress;
			lowerLegL1.rotateAngleX = 0.24434609527920614F + (PI - 0.24434609527920614F) * progress;
			...
			lowerlegR6.rotateAngleY = -PI / 2 * progress;
			lowerlegR6.rotateAngleX = 0.45378560551852565F * f;
			lowerlegL6.setRotationPoint(-1 + 2 * progress, 2 * progress, 2 + progress / 2);
			lowerlegL6.rotateAngleY = PI / 2 * progress;
			lowerlegL6.rotateAngleX = -0.45378560551852565F * f;
			backplate2.setRotationPoint(progress * -2.01F, -3 + 4.5F * progress, 3);
			setRotateAngle(backplate2, 0.017453292519943295F * f, 0.12217304763960307F * f - progress * PI / 2, -0.10471975511965977F * f);
			backplate1.setRotationPoint(progress * 2.01F, -3 + 4.5F * progress, 3);
			setRotateAngle(backplate1, 0.017453292519943295F * f, 0.12217304763960307F * f + progress * PI / 2, -0.10471975511965977F * f);
			fistL.rotateAngleZ = progress * PI / 2;
			...
			fistR.rotateAngleZ = progress * -PI / 2;
