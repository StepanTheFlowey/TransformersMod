...
public class ModelCloudtrap extends ModelTransformerBase {
	...
	public void doFallingAnimations(EntityPlayer player, float progress, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, boolean wearingHead, boolean wearingChest, boolean wearingLegs, boolean wearingFeet) {
		...
		head.rotateAngleX -= 0.2F * upwardPose;
		torsoConnector.rotateAngleX -= 0.2F * upwardPose;

		rightshoulderbase.rotateAngleZ -= 0.5F * upwardPose;
		leftshoulderbase.rotateAngleZ += 0.5F * upwardPose;

		upperLegR.rotateAngleX -= 0.5F * upwardPose * 1.25F;
		lowerlegRbase.rotateAngleX += 0.75F * upwardPose * 1.25F;

		upperLegL.rotateAngleX -= 0.5F * upwardPose * 1.25F;
		lowerlegLbase.rotateAngleX += 0.75F * upwardPose * 1.25F;

		feetbaseL.rotateAngleX -= 0.45F * upwardPose * 1.25F;
		feetbaseR.rotateAngleX -= 0.45F * upwardPose * 1.25F;

		upperLegR.rotateAngleX += 0.2F * upwardPose;
		upperLegL.rotateAngleX -= 0.2F * upwardPose;

		feetbaseL.rotateAngleX += 0.2F * upwardPose;
		feetbaseR.rotateAngleX -= 0.2F * upwardPose;

		waist.rotateAngleX += 0.25F * upwardPose * 1.25F;
