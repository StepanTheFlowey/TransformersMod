...
public class ModelBoxBreakable extends ModelBox {
	...
	public ModelBoxBreakable(ModelRendererBreakable modelRenderer, int textureX, int textureY, float x, float y, float z, int width, int height, int depth, float mcScale) {
		...
		final PositionTextureVertex positiontexturevertex = new PositionTextureVertex(x2, y, z, 0, 8);
		final PositionTextureVertex positiontexturevertex1 = new PositionTextureVertex(x2, y2, z, 8, 8);
		final PositionTextureVertex positiontexturevertex2 = new PositionTextureVertex(x, y2, z, 8, 0);
		final PositionTextureVertex positiontexturevertex3 = new PositionTextureVertex(x, y, z2, 0, 0);
		final PositionTextureVertex positiontexturevertex4 = new PositionTextureVertex(x2, y, z2, 0, 8);
