...
public class ModelEnergonProcessor extends MowzieModelBase {
	private final MowzieModelRenderer flap1;
	private final MowzieModelRenderer flap2;
	private final MowzieModelRenderer rotatechamber_base;
	private final MowzieModelRenderer rotatingrod_top;
	private final MowzieModelRenderer shape1;
	private final MowzieModelRenderer shape1_1;
	private final MowzieModelRenderer shape1_2;
	private final MowzieModelRenderer shape12;
	private final MowzieModelRenderer shape14;
	private final MowzieModelRenderer shape14_1;
	private final MowzieModelRenderer shape16;
	private final MowzieModelRenderer shape16_1;
	private final MowzieModelRenderer shape2;
	private final MowzieModelRenderer shape20;
	private final MowzieModelRenderer shape20_1;
	private final MowzieModelRenderer shape2_1;
	private final MowzieModelRenderer shape2_2;
	private final MowzieModelRenderer shape2_3;
	private final MowzieModelRenderer shape27;
	private final MowzieModelRenderer shape27_1;
	private final MowzieModelRenderer shape27_2;
	private final MowzieModelRenderer shape27_3;
	private final MowzieModelRenderer shape7;
	...
	public ModelEnergonProcessor() {
		...
		final MowzieModelRenderer shape31 = new ModelRendererBreakable(this, 0, 33);
	...
	public void render(final TileEntityEnergonProcessor tileentity) {
		if(tileentity.burnTime == 0) {
			setToInitPose();
		}

		final float animationTimer = TFHelper.median(tileentity.animationTimer, tileentity.prevAnimationTimer, ClientTickHandler.renderTick);
		final float animationBurnTime = tileentity.burnTime > 0 ? tileentity.animationBurnTime + ClientTickHandler.renderTick : 0;
	...
	private void setRotateAngle(final MowzieModelRenderer model, final float x, final float y, final float z) {
